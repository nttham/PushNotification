...
function deleteDevice(index,devices) {
    ...
    var deviceToken = $scope.devices[index].deviceToken;

    $http.delete('/devices/'+deviceToken).then(function(response) {
...
$scope.showSendMessageDialog = function(ev,index) {
    ...
    $mdDialog.show(confirm).then(function(result) {
    	...
    	var message = result;
    	var deviceToken = $scope.devices[index].deviceToken;
        var deviceId = $scope.devices[index].deviceId;
      	console.log('okay'+ message +deviceToken);
